...
public record UserResponse(
        ...
        @Schema(description = "Rol asignado", example = "STUDENT") String role,
        ...
        @Schema(description = "IDs de cursos en los que el usuario está inscripto", example = "[1, 2, 5]") List<Long> enrolledCourses
) {}